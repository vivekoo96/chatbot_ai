<x-admin-layout>
    <div class="max-w-2xl mx-auto">
        <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Create New Add-on</h2>
            ...
            <form action="{{ route('admin.addons.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required placeholder="+5,000 Messages"
                    ...
                    <div>
                        ...
                        <select name="type" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                            <option value="messages" {{ old('type') == 'messages' ? 'selected' : '' }}>Chat Messages
                            </option>
                            <option value="voice" {{ old('type') == 'voice' ? 'selected' : '' }}>Voice Minutes</option>
                            <option value="images" {{ old('type') == 'images' ? 'selected' : '' }}>Image Uploads</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="price_inr" value="{{ old('price_inr') }}" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="price_usd" value="{{ old('price_usd') }}" required
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    </div>
